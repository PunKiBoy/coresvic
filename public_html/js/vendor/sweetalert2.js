...
var sweetHTML = ('\n  <div class="' + swalClasses.modal + '" tabIndex="-1">\n    <ul class="' + swalClasses.progresssteps + '"></ul>\n    <div class="' + swalClasses.icon + ' ' + iconTypes.error + '">\n      <i class="fa fa-ban pulse-warning h1 text-danger"></i>\n    </div>\n    <div class="' + swalClasses.icon + ' ' + iconTypes.question + '"><i class="fa fa-question-circle h1 pulse-warning text-primary"></i></div>\n    <div class="' + swalClasses.icon + ' ' + iconTypes.warning + '"><i class="fa fa-exclamation-triangle pulse-warning h1 text-warning"></i></div>\n    <div class="' + swalClasses.icon + ' ' + iconTypes.info + '"><i class="fa fa-info-circle h1 pulse-warning text-info"></i></div>\n    <div class="' + swalClasses.icon + ' ' + iconTypes.success + '">\n      <i class="fa fa-check-circle-o pulse-warning h1 text-success"></i>\n      <div class="placeholder"></div>\n    </div>\n    <img class="' + swalClasses.image + '">\n    <h2 class="' + swalClasses.title + '"></h2>\n    <div class="' + swalClasses.content + '"></div>\n    <input class="' + swalClasses.input + '">\n    <input type="file" class="' + swalClasses.file + '">\n    <div class="' + swalClasses.range + '">\n      <output></output>\n      <input type="range">\n    </div>\n    <select class="' + swalClasses.select + '"></select>\n    <div class="' + swalClasses.radio + '"></div>\n    <label for="' + swalClasses.checkbox + '" class="' + swalClasses.checkbox + '">\n      <input type="checkbox">\n    </label>\n    <textarea class="' + swalClasses.textarea + '"></textarea>\n    <div class="' + swalClasses.validationerror + '"></div>\n    <hr class="' + swalClasses.spacer + '">\n    <button type="button" class="' + swalClasses.confirm + '">OK</button>\n    <button type="button" class="' + swalClasses.cancel + '">Cancel</button>\n    <span class="' + swalClasses.close + '">&times;</span>\n  </div>\n').replace(/(^|\n)\s*/g, '');
